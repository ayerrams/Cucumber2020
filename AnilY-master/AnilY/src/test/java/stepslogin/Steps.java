...
public class Steps {
	...
	System.setProperty("webdriver.chrome.driver", "C://Users//AnilYerramsetti//Downloads//chromedriver_win32//chromedriver.exe");
	...
	public void i_enter_the_first_name_as(String string) {
		driver.findElement(By.id("registration_firstname")).sendKeys("Anil");
	...
	public void i_enter_the_e_mail_as(String string) {
		driver.findElement(By.id("registration_email")).sendKeys("ayerrams@abc.com");
	    
	}
	@When("I enter the User as {string}")
	public void i_enter_the_user_as(String string) {
		driver.findElement(By.id("username")).sendKeys("anilk");
	...
	public void i_enter_the_username_as(String string) {
		driver.findElement(By.id("login")).sendKeys("anily");
	...
	public void i_validate_the_user_register_successfully() {
		driver.getPageSource().contains("Dear AnilY");
	...
	public void i_validate_the_email() {
		...
		driver.getPageSource().contains("anily@abc.com");
